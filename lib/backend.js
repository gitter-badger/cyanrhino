...
module.exports = exports = function(app){
	...
	app.get('/backend/album/:uuid', ensureAuthenticated, ensureAdmin, backend.album);
	app.get('/backend/album/remove/:_id',ensureAuthenticated, backend.albumRemove);
	app.post('/backend/album/add/:coverId/:photo',ensureAuthenticated, backend.albumAdd);
	app.post('/backend/album/update/:coverId/:photo',ensureAuthenticated, backend.albumUpdate);
