...
var usr = new User({ username: 'admin', email: 'llliz1023@gmail.com', password: 'password',is_admin:true });
...
usr = new User({ username: 'user', email: 'ishida1983@gmail.com', password: 'password',is_admin:false });
usr.save(function(err) {
	if(err) {
		console.log(err);
	} else {
